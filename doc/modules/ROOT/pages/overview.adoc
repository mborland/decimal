...
The types and many of the functions also natively support running on GPUs using CUDA.
...
A JOSS paper for this library can be found at https://joss.theoj.org/papers/10.21105/joss.10345.
A citation is available at that link, or in the repository as https://github.com/boostorg/decimal/blob/develop/CITATION.cff[CITATION.cff].
